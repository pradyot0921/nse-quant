...
- UDiFF row-level ISIN changes are an independent validation signal. An ISIN change without a same-date corporate-action record of any type must halt or quarantine the symbol/date as a possible missing corporate action.
